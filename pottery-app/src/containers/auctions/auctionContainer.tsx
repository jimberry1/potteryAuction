export const auctioncontainer: any = 0;
...
// import BasicAuctionComponent from '../../components/auction/deprecatedAuctionTypeComponent';
...
// /**
//  *
//  * NOTE -- THIS CONTAINER IS DEPRECATED UNTIL LATER VERSIONS. WE HAVE DECIDED TO PROCEED WITH THE ARTWORK ITEM STORING ALL REQUIRED INFORMATION
//  *
...
//     // updateArtworkAsSoldForArtworkId(auction.data.artworkId); // this function was changed to also take a user id and update that on the artwork
